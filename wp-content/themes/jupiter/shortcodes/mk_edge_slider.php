...
$output .= '<div id="mk-edge-slider-'.$id.'" class="mk-edge-slider swiper-container first-el-' . $first_el . '" data-animation="'.$animation_effect.'" data-height="'.$height.'" data-first="' . $first_el . '" data-fullHeight="'.$full_height.'" data-pause="'.$slideshow_speed.'" data-speed="'.$animation_speed.'" data-pagination="'.$pagination_class.'">';
