...
$output = '<div id="mk-tab-slider-'.$id.'" data-id="'.$id.'" data-autoplay="'.$autoplay_time.'" class="mk-tab-slider '.$animation_css.$el_class.'">';
	...
	while ( $r->have_posts() ) : $r->the_post();
	   ...
	   if ( empty( $menu_text ) ) {
			$nav_output .= '<a href="#" title="" style="font-size:'.$button_size.'px; color:'.$button_color.';"><i class="'.$menu_icon.'"></i></a></li>';
		}else{
			$nav_output .= '<a href="#" title="" style="font-size:'.$button_size.'px; color:'.$button_color.';">'.$menu_text.'</a></li>';
		}
