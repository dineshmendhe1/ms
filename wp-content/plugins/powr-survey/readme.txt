...
== Description ==
[youtube https://www.youtube.com/watch?v=sMHW9ooMrpg] Unique, beautiful, responsive surveys for your site.
<br>
<br>
...
<br>
= <a href='https://www.powr.io/tutorials/how-to-add-survey-plugin-to-your-wordpress-site'>2 MINUTE INSTALL</a> =
<br>
= Free Features =
...
* Accept payments through PayPal and Credit Cards.
...
= <a href='https://www.powr.io/plugins/survey'>More Info</a> =
<br>
...
= How do I add Survey to a page or blog post? = Add the shortcode **[powr-survey label='Enter any label here']** to any page or post. Then visit your live site to edit.

= Can I add more than one Survey? = Yes, absolutely!  To clone your Survey, just add the exact same shortcode to pages or posts.  To create a new version of Survey, add a different shortcode to each page or post, for example: **[powr-survey label='first form']**, and **[powr-survey label='second form']**.
