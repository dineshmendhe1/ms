<?php
    ...
    */
    ...
    function powr_photo_watermark_menu() {
      add_menu_page( 'POWr Photo Watermark', 'POWr Photo Watermark', 'manage_options', 'powr-photo-watermark-settings', powr_photo_watermark_options, 'https://s3-us-west-1.amazonaws.com/powr/platforms/wordpress/16x16_icons/PhotoWatermark.png');
      add_submenu_page( 'powr-photo-watermark-settings', 'POWr - Create', 'Create', 'manage_options', 'powr-photo-watermark-create', powr_photo_watermark_create_options);
      add_submenu_page( 'powr-photo-watermark-settings', 'POWr - Manage', 'Manage', 'manage_options', 'powr-photo-watermark-manage', powr_photo_watermark_manage_options);
      add_submenu_page( 'powr-photo-watermark-settings', 'POWr - Help', 'Help', 'manage_options', 'powr-photo-watermark-help', powr_photo_watermark_help_options);
    }
    function powr_photo_watermark_options() {
      if ( !current_user_can( 'manage_options' ) )  {
        wp_die( __( 'You do not have sufficient permissions to access this page.' ) );
      }
      echo '<iframe id="powr-photo-watermark" src="https://www.powr.io/wp/photo-watermark" frameborder="0" width="100%" height="600px" style="position:absolute; top:0; left:0;z-index: 100;"></iframe>';
      echo '<script>';
      echo 'var ht = window.innerHeight - document.getElementById("wpadminbar").offsetHeight;';
      echo 'var iframe = document.getElementById("powr-photo-watermark"); iframe.style.height = ht+"px"; iframe.height = ht;';
      echo '</script>';
    }
    function powr_photo_watermark_create_options() {
      if ( !current_user_can( 'manage_options' ) )  {
        wp_die( __( 'You do not have sufficient permissions to access this page.' ) );
      }
      echo '<iframe id="powr-create-photo-watermark" src="https://www.powr.io/wp-create/photo-watermark?powr_token='.get_option('powr_token').'" frameborder="0" width="100%" height="600px" style="position:absolute; top:0; left:0;z-index: 100;"></iframe>';
      echo '<script>';
      echo 'var ht = window.innerHeight - document.getElementById("wpadminbar").offsetHeight;';
      echo 'var iframe = document.getElementById("powr-create-photo-watermark"); iframe.style.height = ht+"px"; iframe.height = ht;';
      echo '</script>';
    }
    function powr_photo_watermark_manage_options() {
      if ( !current_user_can( 'manage_options' ) )  {
        wp_die( __( 'You do not have sufficient permissions to access this page.' ) );
      }
      echo '<iframe id="powr-manage-photo-watermark" src="https://www.powr.io/wp-manage/photo-watermark" frameborder="0" width="100%" height="600px" style="position:absolute; top:0; left:0; z-index: 100;"></iframe>';
      echo '<script>';
      echo 'var ht = window.innerHeight - document.getElementById("wpadminbar").offsetHeight;';
      echo 'var iframe = document.getElementById("powr-manage-photo-watermark"); iframe.style.height = ht+"px"; iframe.height = ht;';
      echo '</script>';
    }
    function powr_photo_watermark_help_options() {
      if ( !current_user_can( 'manage_options' ) )  {
        wp_die( __( 'You do not have sufficient permissions to access this page.' ) );
      }
      echo '<iframe id="powr-help-photo-watermark" src="https://www.powr.io/knowledge-base?src=wordpress" frameborder="0" width="100%" height="600px" style="position:absolute; top:0; left:0; z-index: 100;"></iframe>';
      echo '<script>';
      echo 'var ht = window.innerHeight - document.getElementById("wpadminbar").offsetHeight;';
      echo 'var iframe = document.getElementById("powr-help-photo-watermark"); iframe.style.height = ht+"px"; iframe.height = ht;';
      echo '</script>';
    }
  ?>