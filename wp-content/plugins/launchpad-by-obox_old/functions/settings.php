<?php class apollo_launchpad_settings
{
	...
	function apollo_initialize_options() {
		...
		add_settings_field(
			...
			'When does your site launch? Server time is: <em>'  . current_time( get_option( 'date_format' ) . ' ' . get_option( 'time_format' ) ) . '</em> <a href="' . admin_url( 'options-general.php' ) . '" target="_blank">(Edit)</a>')
		);
