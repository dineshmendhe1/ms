...
<br>
<br>
First, download, install, and activate POWr Contact Form. Then drop the widget anywhere in your theme. Or add to a page/post with the POWr icon in the WP editor.
<br>
= <a href='https://www.powr.io/tutorials/how-to-add-contact-form-plugin-to-your-wordpress-site'>2 MINUTE INSTALL</a> =
<br>
= Free Features =
...
= How do I add Contact Form to a page or blog post? = Add the shortcode **[powr-contact-form label='Enter any label here']** to any page or post. Then visit your live site to edit.

= Can I add more than one Contact Form? = Yes, absolutely!  To clone your Contact Form, just add the exact same shortcode to pages or posts.  To create a new version of Contact Form, add a different shortcode to each page or post, for example: **[powr-contact-form label='first form']**, and **[powr-contact-form label='second form']**.

= Will my users see the settings icon in the corner of the Contact Form? = No! You only see the settings icon because you own the plugins. To temporarily hide it, click on your page and then type 'p + down arrow' (the letter p followed by the down arrow). You can show the icon again by typing 'p + up-arrow'.
