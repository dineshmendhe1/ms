<?php
    ...
    Description: Simple, beautiful forms in seconds!  Drop the widget anywhere in your theme. Or use the POWr icon in your WP text editor to add to a page or post. Edit on your live page by clicking the settings icon. More plugins and tutorials at POWr.io.
    Author: POWr.io
    Version: 1.4
    ...
    */
    ...
    function powr_form_builder_menu() {
      add_menu_page( 'POWr Form Builder', 'POWr Form Builder', 'manage_options', 'powr-form-builder-settings', powr_form_builder_options, 'https://s3-us-west-1.amazonaws.com/powr/platforms/wordpress/16x16_icons/FormBuilder.png');
      add_submenu_page( 'powr-form-builder-settings', 'POWr - Create', 'Create', 'manage_options', 'powr-form-builder-create', powr_form_builder_create_options);
      add_submenu_page( 'powr-form-builder-settings', 'POWr - Manage', 'Manage', 'manage_options', 'powr-form-builder-manage', powr_form_builder_manage_options);
      add_submenu_page( 'powr-form-builder-settings', 'POWr - Help', 'Help', 'manage_options', 'powr-form-builder-help', powr_form_builder_help_options);
    }
    function powr_form_builder_options() {
      if ( !current_user_can( 'manage_options' ) )  {
        wp_die( __( 'You do not have sufficient permissions to access this page.' ) );
      }
      echo '<iframe id="powr-form-builder" src="https://www.powr.io/wp/form-builder" frameborder="0" width="100%" height="600px" style="position:absolute; top:0; left:0;z-index: 100;"></iframe>';
      echo '<script>';
      echo 'var ht = window.innerHeight - document.getElementById("wpadminbar").offsetHeight;';
      echo 'var iframe = document.getElementById("powr-form-builder"); iframe.style.height = ht+"px"; iframe.height = ht;';
      echo '</script>';
    }
    function powr_form_builder_create_options() {
      if ( !current_user_can( 'manage_options' ) )  {
        wp_die( __( 'You do not have sufficient permissions to access this page.' ) );
      }
      echo '<iframe id="powr-create-form-builder" src="https://www.powr.io/wp-create/form-builder?powr_token='.get_option('powr_token').'" frameborder="0" width="100%" height="600px" style="position:absolute; top:0; left:0;z-index: 100;"></iframe>';
      echo '<script>';
      echo 'var ht = window.innerHeight - document.getElementById("wpadminbar").offsetHeight;';
      echo 'var iframe = document.getElementById("powr-create-form-builder"); iframe.style.height = ht+"px"; iframe.height = ht;';
      echo '</script>';
    }
    function powr_form_builder_manage_options() {
      if ( !current_user_can( 'manage_options' ) )  {
        wp_die( __( 'You do not have sufficient permissions to access this page.' ) );
      }
      echo '<iframe id="powr-manage-form-builder" src="https://www.powr.io/wp-manage/form-builder" frameborder="0" width="100%" height="600px" style="position:absolute; top:0; left:0; z-index: 100;"></iframe>';
      echo '<script>';
      echo 'var ht = window.innerHeight - document.getElementById("wpadminbar").offsetHeight;';
      echo 'var iframe = document.getElementById("powr-manage-form-builder"); iframe.style.height = ht+"px"; iframe.height = ht;';
      echo '</script>';
    }
    function powr_form_builder_help_options() {
      if ( !current_user_can( 'manage_options' ) )  {
        wp_die( __( 'You do not have sufficient permissions to access this page.' ) );
      }
      echo '<iframe id="powr-help-form-builder" src="https://www.powr.io/knowledge-base?src=wordpress" frameborder="0" width="100%" height="600px" style="position:absolute; top:0; left:0; z-index: 100;"></iframe>';
      echo '<script>';
      echo 'var ht = window.innerHeight - document.getElementById("wpadminbar").offsetHeight;';
      echo 'var iframe = document.getElementById("powr-help-form-builder"); iframe.style.height = ht+"px"; iframe.height = ht;';
      echo '</script>';
    }
  ?>