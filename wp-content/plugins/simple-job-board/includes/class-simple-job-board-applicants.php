            ...
            <div class="wrap"><div id="icon-tools" class="icon32"></div>
                ...
                <h3>
                        ...
                        foreach ($keys as $key) {
                            if ('jobapp_' === substr($key, 0, 7)) {
                                ...
                                if (!empty($place)) {
                                    ...
                                    echo apply_filters( 'sjb_applicant_name', $applicant_name );
                                    break;
                                }
                            }
                        }
                    ...
                    if (in_array('resume', $keys)):
                        $resume = '&nbsp; &nbsp; <small><a href="' . get_post_meta($post->ID, 'resume', TRUE). '" target="_blank" >' .  __('Resume', 'simple-job-board') . '</a></small>';
