...
Tags: job board, career, company, employment, job manager, recruitment, career page, career portal, cv, job portal, resume uploader, vacancy,
...
The plugin is available in English, French(Français), Arabic (العربية), Brazilian Portuguese(Português do Brasil), Italian(Italiano), Russian(Русский), Chinese(简体中文) and Dutch(Nederlands).
...
= You just need to follow the following steps for a fully functional Job Board: =
...
You can use anti-hotlinking option in the settings to enhance the security of your document.
...
* Note - Added SJB add-ons listing.
...
= 2.2.4 =
* Fix - Resolved the pagination issue with job search.
...
* Tweak - Added pagination as default behavior of job listing.
