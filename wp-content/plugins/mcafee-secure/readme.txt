...
* Show visitors your site is safe by displaying the McAfee SECURE trustmark.
...
>
> **New Pro Feature:** 
> Protect your customers with Shopper Identity Protection. Activate to increase sales and customer loyalty. [Click here to learn more.](https://www.mcafeesecure.com/shopper-identity-protection) (Note: Integration is automatically added for WooCommerce sites.)
...
5. [For Pro Users] To add the Shopper Identity Protection trustmark to your site, add the following code to your site [mcafeesecure_sip]
...
* Engagement Trustmark: Unlike the floating trustmark, the engagement trustmark stays in one spot. So whether that’s by a signup form or in the checkout of your sales flow, visitors will know they’re safe as soon as they look at an engagement area. [Watch a video about the Engagement Trustmark here.](http://mcaf.ee/3gxei)
* Shopper Identity Protection: This is the newest feature within the McAfee SECURE service. Take your customer's safety one step further by offering them $100,000 in free identity theft insurance. [Learn more.](https://www.mcafeesecure.com/shopper-identity-protection)

= How do I upgrade to Pro? =

Upgrading is easy! When you upgrade, your trustmark code stays exactly the same. [Login](https://www.mcafeesecure.com/user/) to your account and you'll have to option to [upgrade to Pro](https://www.mcafeesecure.com/start). Once you select this option, you can make your first payment and set everything up in just a few minutes. (Note: you will need to add an additional snippet of code to your site in order to install the engagement trustmark. Don't worry: there are easy-to-follow directions on how to do this once you have completed the upgrade.)
...
5. Upgrade to Pro and give your customers 30 days of free identity theft protection.
...
= 1.6.2 =
* Authorizing sitemap
* Add purchase reviewe email entry

= 1.5.1 =
* Fix wrong endpoint bug

= 1.5.0 =
* WooCommerce & SIP integration
* SIP trustmark shortcode

= 1.4.3 =
* Fix bugs

= 1.4.2 =
* Fix collision with bootstrap

= 1.4.1 =
* Fix background color

= 1.4 =
* Fix saving onboarding state

= 1.3 =
* New dashboard and sign up flow

= 1.2 =
* Use tag for stable version
